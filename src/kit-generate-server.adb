...
package body Kit.Generate.Server is
   ...
   begin
      ...
      Copy_File (Kit.Paths.Config_Path & "/tables.ads",
                 Target_Directory & "/"
                 & Make_File_Name (Database_Name & ".Tables", "ads"),
                 Standard_Sub);
      Copy_File (Kit.Paths.Config_Path & "/tables.adb",
                 Target_Directory & "/"
                 & Make_File_Name (Database_Name & ".Tables", "adb"),
                 Standard_Sub);
